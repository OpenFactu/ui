...
export const GlobalLoader: React.FC<GlobalLoaderProps> = ({ isLoading, message }) => {
  ...
  return (
    <div className="fixed inset-0 z-[var(--k-z-modal,99999)] flex flex-col items-center justify-center bg-white/80 dark:bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-300">
